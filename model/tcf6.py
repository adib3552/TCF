...
class EncoderLayer(nn.Module):
    ...
    def forward(self, x, B, N, D, var, x_mask=None, tau=None, delta=None):
...
class Encoder(nn.Module):
    ...
    def forward(self, x, b, n, d, var, x_mask=None, tau=None, delta=None):
        for layer in self.layers:
            x = layer(x, b, n, d, var, x_mask=x_mask, tau=tau, delta=delta)
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.var_embedding = DataEmbedding_inverted(configs.seq_len, configs.d_model, configs.embed, configs.freq,
                                                   configs.dropout)
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        var_embed = self.var_embedding(x_enc, x_mark_enc)
        
        enc_out = self.encoder(enc_out, b, n, d, var_embed)
